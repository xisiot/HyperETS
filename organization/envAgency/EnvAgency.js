...
function EnvAgency(config) {
  ...
  //add peers
  config.envAgency.peers.forEach(host => {
...
var prototype = EnvAgency.prototype;
...
prototype.enrollAdmin = function () {
  ...
  return Fabric_Client.newDefaultKeyValueStore({
    ...
    fabric_ca_client = new Fabric_CA_Client(_this.config.envAgency.ca.host, tlsOptions, _this.config.envAgency.ca.name, crypto_suite);
    ...
    if (user_from_store && user_from_store.isEnrolled()) {
      ...
      return fabric_ca_client.enroll({
        ...
        return fabric_client.createUser(
          {
            username: 'admin',
            mspid: _this.config.envAgency.mspid,
...
prototype.register = function (username, password) {
  var _this = this;
  ...
  return _this.invoke(request).then(res => Promise.resolve())
    .catch(err => Promise.reject(err.toString()));
};

prototype.getUserInfo = function (username) {
  var _this = this;
...
prototype.getCorpApprovals = function (username, status) {
  var _this = this;
  var request = null;
  var statusStr = null;
  ...
  if (username) {
    ...
    if (status) {
      ...
      statusStr = JSON.stringify(['processing', 'accepted', 'rejected']);
    }

    request = {
      fcn: 'getCorpApprovals',
      args: [statusStr],
    }
  }
...
prototype.postCorpApproval = function (approval) {
  var _this = this;

  var request = {
    fcn: 'postCorpApproval',
    args: [JSON.stringify(approval)]
  };
...
prototype.getCorpApproval = function (id) {
  var _this = this;
...
prototype.getProject = function (id) {
  var _this = this;
...
prototype.postProject = function (project) {
  var _this = this;
...
prototype.getProjects = function (username, status) {
  var _this = this;
  var request = null;
  var statusStr = null;
  ...
  if (username) {
    ...
    if (status) {
      ...
      statusStr = JSON.stringify(['processing', 'accepted', 'rejected', 'trading', 'done']);
    }
...
prototype.signCorpApproval = function (id, status) {
  var _this = this;

  var request = {
    fcn: 'signCorpApproval',
    args: [id, status]
  };
...
prototype.signProject = function (id, status) {
  var _this = this;
